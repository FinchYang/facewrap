...
#pragma comment(lib, "E:/BaiduNetdiskDownload/windows_c_sdk_x64_small_440hard_release_20180306/windows_c_sdk_x64_small_440hard_release_20180306/exe/core_sdk.lib")
...
{ 
    ...
    printf("mgv_create_engine return:%s\n", mgv_get_error_str(ret));
    if (engine == NULL)
    {
        printf("engine error");
        return -11;
