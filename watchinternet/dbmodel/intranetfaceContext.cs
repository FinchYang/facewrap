...
namespace watchinternet.dbmodel
{
    public partial class intranetfaceContext : DbContext
    {
        public virtual DbSet<Comparelog> Comparelog { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=localhost;port=3306;User Id=root;Password=root;Database=intranetface ");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Comparelog>(entity =>
            {
                entity.HasKey(e => e.Idcomparelog);

                entity.ToTable("comparelog");

                entity.HasIndex(e => e.Idcomparelog)
                    .HasName("idcomparelog_UNIQUE")
                    .IsUnique();

                entity.Property(e => e.Idcomparelog)
                    .HasColumnName("idcomparelog")
                    .HasColumnType("int(11)");

                entity.Property(e => e.Comparelogcol)
                    .HasColumnName("comparelogcol")
                    .HasMaxLength(45);
